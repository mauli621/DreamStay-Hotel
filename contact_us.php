...
<body>
    ...
    <section>
        <div class="contact-img">
            <img src="./assets/contact_us_bg.jpg" class="contact" />
        </div>
        <div class="inner-text">
            <h1 class="heading">We're Here To Help !</h1>
            <h1 class="tagline">Have questions or want to book directly? Reach out to us below.</h1>
        </div>
    </section>
    ...
    <div class="contact-para">
        ...
        <ul>
            <li class="contact-video">
                <video src="./assets/contact-video.mp4" autoplay loop muted>
            </li>
        </ul>
    </div>
